...
//            }
//            cell.textView.frame = CGRect(x: textViewXOffset,
//                                         y: 5,
//                                         width: estimatedSize.width + (MessageTextView.contentInset),
...
//        }
//
//        let maxWidth = (collectionView.width - 20) - (MessageTextView.contentInset * 2) * 0.7
//        var size = attributedString.getSize(withWidth: maxWidth)
//        size.height += MessageTextView.contentInset * 2
//        return size
//    }
}
